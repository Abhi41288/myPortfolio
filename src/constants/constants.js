export const projects = [
  {
    title: 'Search Images of your favorite places',
    description: "This project is built using Angular and Material UI by using external API.",
      image: '/images/1.png',
      tags: ['Angular', 'MaterialUI'],
    source: 'https://github.com/Abhi41288/image-search-with-angular',
    visit: 'https://angular-image-search.web.app',
    id: 0,
  },
  {
    title: 'Lets Social',
    description:"Its a mid size social network application build using React and firebase,yeah do checkout!!!.",
    image: '/images/2.png',
    tags: ['React', 'JavaScript'],
    source: 'https://google.comhttps://github.com/Abhi41288/lets_social',
    visit: 'https://lets-social-a540f.web.app',
    id: 1,
  },
  {
...
export const TimeLineData = [
  { year: 2015, text: 'Started my journey with IBM as System Engineer', },
